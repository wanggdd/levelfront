...
<div id="user">
    <div class="info">
        <div class="avatar">
            ...
            <a href="/dom/NineFenXiao/myinfo.php?zz_userid=<{$zz_userid}>&username=<{$username}>&wap=1"><img class="write-image" src="/public/images/userInfo/icon-write.png" alt=""></a>
        </div>
        <div class="desc">
            <div class="d-top">
    ...
    <div class="handles">
        ...
        <div class="item" onclick="location='/dom/NineFenXiao/mytask.php?zz_userid=<{$zz_userid}>&username=<{$username}>&wap=1';">
            <img class="icon-pending" src="/public/images/userInfo/icon-pending.png" alt="">
            <p>我的待办</p>
        </div>
        <div class="item" onclick="location='/dom/NineFenXiao/finance.php?zz_userid=<{$zz_userid}>&username=<{$username}>&wap=1';">
        ...
        <div class="item" onclick="location='/dom/NineFenXiao/mylower.php?zz_userid=<{$zz_userid}>&username=<{$username}>&wap=1';">
            <img class="icon-branch" src="/public/images/userInfo/icon-branch.png" alt="">
            <p>我的下级</p>
        </div>
        <div class="item" onclick="location='/dom/NineFenXiao/invite.php?zz_userid=<{$zz_userid}>&username=<{$username}>&wap=1';">
